...
import {SigningUpDialogComponent} from './pages/sign-up-page/signing-up-dialog.component';
import {AccountExistDialogComponent} from './pages/sign-up-page/account-exist-dialog.component';
import {ContactSupportDialogComponent} from './pages/sign-up-page/contact-support-dialog.component';
import {PasswordExpireDialogComponent} from './pages/sign-up-page/password-expire-dialog.component';
import {SignInDialogComponent} from './pages/sign-up-page/sign-in-dialog.component';
import {ErrorDialogComponent} from './pages/sign-up-page/error-dialog.component';
